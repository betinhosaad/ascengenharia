...
class BoletosControllerTest < ActionController::TestCase
  ...
  test "should create boleto" do
    assert_difference('Boleto.count') do
      post :create, boleto: { descricao: @boleto.descricao, parcelas: @boleto.parcelas, preco: @boleto.preco, situacao: @boleto.situacao, vencimento: @boleto.vencimento }
    end
  ...
  test "should update boleto" do
    patch :update, id: @boleto, boleto: { descricao: @boleto.descricao, parcelas: @boleto.parcelas, preco: @boleto.preco, situacao: @boleto.situacao, vencimento: @boleto.vencimento }
    assert_redirected_to boleto_path(assigns(:boleto))
  end
