...
class ObrasControllerTest < ActionController::TestCase
  ...
  test "should create obra" do
    assert_difference('Obra.count') do
      post :create, obra: { description: @obra.description, locale: @obra.locale, name: @obra.name, start_date: @obra.start_date }
    end
  ...
  test "should update obra" do
    patch :update, id: @obra, obra: { description: @obra.description, locale: @obra.locale, name: @obra.name, start_date: @obra.start_date }
    assert_redirected_to obra_path(assigns(:obra))
  end
